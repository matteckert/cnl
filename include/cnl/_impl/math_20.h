...
template<class T> concept MyFloatingPoint = std::is_floating_point_v<T>;
...
namespace cnl {
    namespace math {
        ...
        template <MyFloatingPoint T> inline constexpr T e_v<T>          = T(2.718281828459045235360287471352662498L);
        template <MyFloatingPoint T> inline constexpr T log2e_v<T>      = T(1.442695040888963407359924681001892137L);
        template <MyFloatingPoint T> inline constexpr T log10e_v<T>     = T(0.434294481903251827651128918916605082L);
        template <MyFloatingPoint T> inline constexpr T pi_v<T>         = T(3.141592653589793238462643383279502884L);
        template <MyFloatingPoint T> inline constexpr T inv_pi_v<T>     = T(0.318309886183790671537767526745028724L);
        template <MyFloatingPoint T> inline constexpr T inv_sqrtpi_v<T> = T(0.564189583547756286948079451560772586L);
        template <MyFloatingPoint T> inline constexpr T ln2_v<T>        = T(0.693147180559945309417232121458176568L);
        template <MyFloatingPoint T> inline constexpr T ln10_v<T>       = T(2.302585092994045684017991454684364208L);
        template <MyFloatingPoint T> inline constexpr T sqrt2_v<T>      = T(1.414213562373095048801688724209698078L);
        template <MyFloatingPoint T> inline constexpr T sqrt3_v<T>      = T(1.732050807568877293527446341505872366L);
        template <MyFloatingPoint T> inline constexpr T inv_sqrt3_v<T>  = T(0.577350269189625764509148780501957456L);
        template <MyFloatingPoint T> inline constexpr T egamma_v<T>     = T(0.577215664901532860606512090082402431L);
        template <MyFloatingPoint T> inline constexpr T phi_v<T>        = T(1.618033988749894848204586834365638117L);
